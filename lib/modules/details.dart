...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async{
        widget.isFavourite!?
        Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => HomeScreen(currentIndex: 1,),), (route) => false):Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => HomeScreen(currentIndex: 0,),), (route) => false);
        return true;
      },
      child: Scaffold(
